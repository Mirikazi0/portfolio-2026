...
* **What He Cares About:** High-velocity visual execution, brand consistency across multi-channel campaigns, clear communication, ownership, and alignment with client growth goals.
...
## ❓ Strategic Questions to Ask Jason (The Founder)

1. **On 90-Day Success:**
   > *"For a Visual Designer coming into SetSail, what does exceptional performance look like in the first 90 days?"*

2. **On Design Infrastructure:**
   > *"As SetSail scales its client roster, how do your creative teams manage style guide governance across different client accounts?"*
